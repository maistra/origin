...
function os::build::get_product_vars() {
  ...
  export OS_BUILD_LDFLAGS_ISTIO_IMAGE_VERSION="${OS_ISTIO_IMAGE_VERSION:-"0.8.0"}"
  export OS_BUILD_LDFLAGS_ISTIO_JAEGER_IMAGE_VERSION="${OS_ISTIO_IMAGE_VERSION:-"1.4.1"}"
...
function os::build::ldflags() {
  ...
  ldflags+=($(os::build::ldflag "${OS_GO_PACKAGE}/pkg/cmd/util/variable.DefaultIstioJaegerImageVersion" "${OS_BUILD_LDFLAGS_ISTIO_JAEGER_IMAGE_VERSION}"))
